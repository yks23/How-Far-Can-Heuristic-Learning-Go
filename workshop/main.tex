...
\author{Qingle Liu$^{*,\dagger}$, Kejin Wang$^{*}$, Yicheng Zhao$^{*}$, Jieming Li$^{*}$, Shenghan Zheng$^{*}$, Ruize Yang$^{*}$, Bojun Yang$^{*}$, Heng Gong, Xiang Gao, Lanyue Zhang, Kaiyu Zhong, Zhuo Liu, Shaoxuan Li, Chengxi Li, Weixuan Zhang, Huan-ang Gao, Kaisen Yang$^{\dagger,\ddagger}$\\[3pt]
\small $^{*}$ Core Contributor \quad $^{\dagger}$ Project Lead \quad $^{\ddagger}$ Corresponding Author\\
\small Department of Computer Science and Technology, Tsinghua University\\
\small Acknowledgement: We thank the many members of the Student Association of the Department of Computer Science and Technology at Tsinghua University for developing and maintaining the Agent Competition over the years and for supporting this work.}
