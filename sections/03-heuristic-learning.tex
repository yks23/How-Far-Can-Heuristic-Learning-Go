...
\textbf{Observation 1: readable and intelligible.} A symbolic policy exposes
the decisions it makes as meaningful, inspectable program constructs.}}
\end{center}
...
policy incorporates new experience only when people continue to revise it.}}
\end{center}
...
\begin{center}
\fcolorbox{brandaccent}{white}{\parbox{0.93\linewidth}{\small
\textbf{Observation 3: coding agents exploit and compensate.} Coding agents use
readable program policies to turn rich feedback into concrete edits while replacing
the human labour required for heuristic maintenance.}}
\end{center}
