...
\section{Adversarial-Game Heuristic Learning}
\label{sec:hl}
...
\emph{Adversarial-game heuristic learning} is the game-scoped form of the paradigm in which an agent interprets feedback
