...
\textbf{Observation.} Symbolic policies are compact and locally editable; learned
policies can be stronger but hide decisions in weights. The missing variable is who can
keep maintaining the artifact.}}
\end{center}
...
\begin{center}
\fcolorbox{brandaccent}{white}{\parbox{0.93\linewidth}{\small
\textbf{Observation.} The cost of a heuristic edit grows with the behavior it must
preserve. A coding agent changes the maintainer, so this ceiling can be measured rather
than assumed.}}
\end{center}
...
\begin{center}
\fcolorbox{brandaccent}{white}{\parbox{0.93\linewidth}{\small
\textbf{Consequence.} Source code and decision-level replays are native inputs to a
coding agent. This motivates AHL: one persistent policy, external opponents, and
referee-side evaluation.}}
\end{center}
