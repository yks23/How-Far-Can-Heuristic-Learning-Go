...
\begin{center}
\fcolorbox{brandaccent}{white}{\parbox{0.93\linewidth}{\small
\textbf{Observation 3: coding agents exploit and compensate.} A coding agent
uses the readability of program policies to turn rich feedback into targeted edits,
while gradually taking over the heuristic maintenance that otherwise requires
human labour.}}
\end{center}
