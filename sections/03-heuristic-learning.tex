...
\textbf{Observation 1: readable and interpretable.} A symbolic policy exposes
the decisions it makes as meaningful, inspectable program constructs.}}
\end{center}

This advantage, however, depends on sustained human heuristic design. When new
...
\begin{center}
\fcolorbox{brandaccent}{white}{\parbox{0.93\linewidth}{\small
\textbf{Observation 2: maintenance requires human labour.} Without sustained
human intervention, a symbolic policy stops incorporating new experience.}}
\end{center}

LLM agents with coding capabilities change this trade-off. First, an LLM
...
\begin{center}
\fcolorbox{brandaccent}{white}{\parbox{0.93\linewidth}{\small
\textbf{Observation 3: the coding-agent loop.} An LLM agent can exploit the
interpretability of program policies through a wide trajectory-to-code feedback
channel, while gradually taking over the human maintenance burden.}}
\end{center}
