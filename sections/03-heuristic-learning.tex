...
We call a game \emph{adversarial} when the policy interacts with an externally
controlled opponent whose behaviour changes the effective environment. Let
$\mathcal{O}$ denote the available opponent pool; each round selects a subset
