...
What the paradigm did not have is a maintainer who could keep paying. Each new
case has to be reconciled with the rules already present, and the reconciliation
is where the cost lives: not in writing the new rule but in establishing that it
does not break the old ones. That cost grows with the program, so revision
eventually stops being worth its price, and where it stops has always been a fact
about the person doing it rather than about what a program can express.
