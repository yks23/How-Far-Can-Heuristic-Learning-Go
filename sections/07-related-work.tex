...
\citep{agentcl2026,clbench2026,harnessengineering2026} --- hence ours is fixed. Trajectory
distillation has likewise been used to turn interaction traces into compact, reusable
skills organized for later retrieval and composition \citep{browserbc2026}; our feedback
is instead written directly into an executable game policy. Ours carries
...
and Garnier et al.~explicitly call their coding-agent revision of executable flow
controllers ``heuristic learning''~\citep{garnier2026heuristic}. Their setting is
continuous control with simulator evaluation, not opponent-relative games; we therefore
use AHL for our narrower game-scoped instantiation. 
