...
\citep{eureka2023,rewarddesignagent2026,agent2rlbench2026} --- which makes ``then let it
write the policy'' the next question rather than a contrarian one, taken up by
