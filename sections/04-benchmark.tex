...
% The heading stays \section{Benchmark} per the user's structure instruction of
% 2026-08-19 rather than becoming \section{HL-Arena}, which would also be idiomatic
% -- change it only if the user asks.
