...
%   train/test split is already fixed in the manifests: 779 train / 4216 test, and
%   9 rows with an EMPTY split field. Those 9 belong to neither pool and must be
%   accounted for before the split is described as covering the archive -- either
%   assign them or report the archive as 4995 split rows out of 5004.
%
